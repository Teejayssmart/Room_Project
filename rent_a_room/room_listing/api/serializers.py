...
from room_listing.models import Room_types,Room_watch_list 


# from django.contrib.auth.models import User
class Room_typesSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room_types
        fields = '__all__'
...
class Room_watch_listSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room_watch_list
        fields = '__all__'
